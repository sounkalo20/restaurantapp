...
const Header = () => {
  ...
  return (
    <header className='fixed w-screen z-50  p-3 px-4'>
        ...
        <div className='hidden md:flex w-full h-full items-center justify-between'>
            ...
            <div  className='flex items-center gap-8'>
                ...
                <div className='relative'>
                    ...
                    alt="profil_utilisateur" 
                    className='w-8 min-w-[35px] min-h-[35px] drop-shadow-xl cursor-pointer rounded-full'
                    onClick={login}
                    />
        ...
        {/* phone */}
        <div className='hidden md:hidden w-full h-full'>
            <Link to={"/"} className='flex items-center gap-2'>
                <img src={Logo} alt="le logo" className='w-9 object-cover'/>
                <p className='text-headingColor text-xl font-bold'>GoodLy</p>
            </Link>
