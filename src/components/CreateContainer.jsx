...
const CreateContainer = () => {
  ...
  function uploadImage(e){
    ...
    uploadTask.on('state_changed' , (snapshot) => {
      ...
      getDownloadURL(uploadTask.snapshot.ref).then(downloadURL => {
        ...
        setIsLoading(false);
        setFields(true);
        setMsg("Image televerser avec succes");
  ...
  function deleteImage(){
    ...
    deleteObject(deleteRef).then(() => {
      ...
      setIsLoading(false);
      setFields(true);
      setMsg("Image Supprimer avec succes")
      setAlertStatus('success');
      setTimeout(() => {
        setFields(false)
      }, 4000);
      ...
      items-center justify-center gap-4'>
        ...
        <div className='w-full'>
          <select onChange={(e) => setCategory(e.target.value)} className='outline-none w-full text-base border-b-2 border-gray-200 p-2 rounded-md cursor-pointer'>
            <option value="other" className='bg-white'>choisissez une categorie</option>
            {
                 ...
                 ( <> 
                    <label className='w-full h-full flex flex-col items-center justify-center cursor-pointer'>
                      <div className='w-full h-full flex flex-col items-center justify-center gap-2'>
                        ...
                        <p className='text-gray-500 hover:text-gray-700'>Cliquez pour televerser</p>
